/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 24ab7cffaed32a8c806307b398c75e1c)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_GOOGLE_API: string;
		NEXT_PUBLIC_GEONAMES_USERNAME: string;
		NEXT_PUBLIC_REPORTS_GOOGLE_MAP_ID_RETRO: string;
		NEXT_PUBLIC_REPORTS_GOOGLE_MAP_ID_BASIC: string;
		WORKER_SELF_REFERENCE: Fetcher /* project-sinag */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BLOB_READ_WRITE_TOKEN" | "NEXT_PUBLIC_GOOGLE_API" | "NEXT_PUBLIC_GEONAMES_USERNAME" | "NEXT_PUBLIC_REPORTS_GOOGLE_MAP_ID_RETRO" | "NEXT_PUBLIC_REPORTS_GOOGLE_MAP_ID_BASIC">> {}
}
